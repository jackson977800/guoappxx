...
共 27 项：3 项沿用历史已完成标记，23 项已实现但待集中验证，1 项为黄果 AI 播放恢复的外部连接阻塞。0.2.12 补入最后六项可继续实施的功能（P2-4、P2-5、P2-6、P2-7、P2-9、P3-1），并完成本轮要求的标题栏、VIP、详情与播放器源码调整；暂停测试期间不把这些项目勾为验收完成。
...
黄果 AI 的实际密钥连接与播放仍未恢复验收。可独立实施的 TODO 功能已接入源码，后续由用户安排集中验证；AI 待可通的入口后继续处理连接与播放问题。
